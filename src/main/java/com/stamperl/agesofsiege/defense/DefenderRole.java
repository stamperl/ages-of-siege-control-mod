...
public enum DefenderRole {
	SOLDIER("soldier", "Soldier", 8.0D, false, "ages_of_siege_soldier"),
	ARCHER("archer", "Archer", 1.0D, true, "ages_of_siege_archer");
	...
	DefenderRole(String id, String displayName, double leashRadius, boolean ranged, String entityTag) {
		this.id = id;
